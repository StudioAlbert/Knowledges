...
> [!abstract] Séance d'1 h — `GPR-UN-VRG-08` · bloc GSDA *VFX, Rendu et Game Feel*
> GP-925 · salle Leman · **non datée** (Module 2 — 23 nov. 2026 → 12 févr. 2027)

## À couvrir

Camera shake, hit stop, scale punch, flash de dégât, traînées, ce qui se règle en courbes
...
- Fiche du bloc : `_GSDA_Tech_Vault/Bloc/VFX, Rendu et Game Feel.md`, ligne `08`

## Liens

- Séance précédente : [[GPR-UN-VRG-07 - Ce qu'est le juice]]
- Séance suivante : [[GPR-UN-VRG-09 - Feedback d'interface]]
