...
Note:
Cette présentation reprend, telle quelle, la partie « Algorithms » de la
séance 07 1/2 : c'est le même jeu de diapos, republié seul pour la
séance qui lui est entièrement consacrée. Si vous projetez 07 1/2 en
entier, celle-ci fait doublon.
...
- 🔗 [Google Slides — 07 Deeper dive into STD 2/2 : Algorithms](https://docs.google.com/presentation/d/1CenjArNtkb4fqlGdJIUSQsAYEOmYvr37RAK6hq6H2dk/edit)

Première partie : [[07 - Deeper dive into STD 1-2 - iofile, stringstream, algorithms]] · Exercices : [[Exercices - 07a - Deeper dive into STD - algorithms]]
...
Note:
C'est le *erase–remove idiom*. `remove` seul laisse le conteneur de la
même taille, avec de la queue indéfinie ; c'est `erase` qui coupe.
